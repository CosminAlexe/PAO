...
public class Autoutilitara extends Vehicul {
    ...
    public String toString() {
        return marca + "," + model + "," + anFabricatie + "," + rulajl + "," + nrLocuri + "," + combustibil + "," +capacitateCilindrica + "," + putere + "," + id + "," + masa + "," + costPeZi ;
    }
    ...
    public void AdaugaAutoutilitara(int id){
    ...
    public void AfisareAutoutilitara(){
